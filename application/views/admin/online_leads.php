		...
		<form method="post"  action="<?php echo base_url()?>admin/save_online_leads">
				...
				<tbody id="table_body">
							...
							<tr id="row_count<?= $data->project_id ?>">
								<td><input type='checkbox' name='check[]' class='check' value="<?=$data->leadid ?>"></td>
								<td><?= $data->source?></td>
								<td><?=$data->name ?></td>
								<td><?= $data->phone ?></td>
								<td><?= $data->email ?></td>
								<td>
									<select name="<?=$data->leadid ?>" required>
										<?php  
									foreach ($projects as $projectdata) {
												?>
											<option value="<?= $projectdata->name ?>"><?=$projectdata->name ?></option>
										<?php } ?>
									</select> 
									<?= $data->project?>
								</td>
